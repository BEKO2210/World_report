...
> **Letzte Aktualisierung:** 31.03.2026 02:15 UTC

### Sub-Scores

| Kategorie | Score | Trend | Gewichtung |
|-----------|-------|-------|------------|
| 🟡 Umwelt | **43.8**/100 | → -0.1 | 25% |
| 🟡 Gesellschaft | **55.3**/100 | → +0 | 25% |
| 🟢 Wirtschaft | **73.1**/100 | → +0.1 | 20% |
...
<sub>
Auto-generiert von der World.One Pipeline | 31.03.2026 02:15 UTC | 40/40 Quellen aktiv
</sub>
